...
class MainWindow(QWidget):
    ...
    def create_label_first(self):
        ...
        label.move(int(self.width() * 0.1 + 30), int(self.height() * 0.1 + 100))

        label.resize(int(self.width() * 0.8), int(self.height() * 0.7))
    ...
    def create_label_second(self):
        ...
        label_second.move(int(self.width() * 0.1 + 30), int(self.height() * 0.1 + 450))
        label_second.resize(int(self.width() * 0.6), int(self.height() * 0.8))
        ...
        if file_path:
            try:
                ...
                if import_image is not None:
                    ...
                    qImg = QImage(self.import_image.data, width, height, bytesPerLine, QImage.Format_RGB888).rgbSwapped()
